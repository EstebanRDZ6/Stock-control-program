    ...
    public class ArticuloSD
    {
        ...
        public string Insertar(Articulo Obj)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@serie", SqlDbType.VarChar).Value = Obj.Serie;
                ...
                Comando.Parameters.Add("@grosor", SqlDbType.VarChar).Value = Obj.Grosor;
                Comando.Parameters.Add("@ancho", SqlDbType.VarChar).Value = Obj.Ancho;
                Comando.Parameters.Add("@color", SqlDbType.VarChar).Value = Obj.Color;
                Comando.Parameters.Add("@material", SqlDbType.VarChar).Value = Obj.Material;
                Comando.Parameters.Add("@peso", SqlDbType.Decimal).Value = Obj.Peso;
                Comando.Parameters.Add("@precio_venta_menor_kilo", SqlDbType.Decimal).Value = Obj.Precio_venta_menor_kilo;
                Comando.Parameters.Add("@precio_venta_mayor_rollo", SqlDbType.Decimal).Value = Obj.Precio_venta_mayor_rollo;
