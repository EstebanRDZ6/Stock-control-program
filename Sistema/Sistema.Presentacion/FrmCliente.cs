    ...
    public partial class FrmCliente : Form
    {
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = PersonaSN.Insertar("Cliente",TxtNombre.Text.Trim(), Convert.ToString(CboTipoDocumento.Text), TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = PersonaSN.Actualizar(Convert.ToInt32(TxtId.Text),"Cliente", this.NombreAnt, TxtNombre.Text.Trim(), Convert.ToString(CboTipoDocumento.Text), TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
