...
namespace Sistema.Presentacion
{
    public partial class FrmIngreso : Form
    {
        ...
        private void FormatoArticulos()
        {
            ...
            DgvArticulos.Columns[7].Width = 50;
            DgvArticulos.Columns[8].Width = 50;
            DgvArticulos.Columns[9].Width = 50;
            DgvArticulos.Columns[10].HeaderText = "Precio Venta";
            DgvArticulos.Columns[11].Width = 60;
            DgvArticulos.Columns[12].Width = 200;
            DgvArticulos.Columns[13].HeaderText = "Descripción";
            DgvArticulos.Columns[14].Width = 100;
