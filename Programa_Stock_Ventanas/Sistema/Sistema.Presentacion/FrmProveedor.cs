...
namespace Sistema.Presentacion
{
    public partial class FrmProveedor : Form
    {
        ...
        private void Listar()
        {
            try
            {
                DgvListado.DataSource = PersonaSN.ListarProveedores();
                this.Formato();
                this.Limpiar();
        ...
        private void Buscar()
        {
            try
            {
                DgvListado.DataSource = PersonaSN.BuscarProveedores(TxtBuscar.Text);
                this.Formato();
                LblTotal.Text = "Total registros: " + Convert.ToString(DgvListado.Rows.Count);
            }
            catch (Exception ex)
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = PersonaSN.Insertar("Proveedor",TxtNombre.Text.Trim(), Convert.ToString(CboTipoDocumento.Text), TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = PersonaSN.Actualizar(Convert.ToInt32(TxtId.Text),"Proveedor", this.NombreAnt, TxtNombre.Text.Trim(), Convert.ToString(CboTipoDocumento.Text), TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in DgvListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Rpta = PersonaSN.Eliminar(Codigo);
